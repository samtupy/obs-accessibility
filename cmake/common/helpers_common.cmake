...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/third_party/plugin-support.c.in")
  configure_file(third_party/plugin-support.c.in plugin-support.c @ONLY)
  add_library(plugin-support STATIC)
  target_sources(plugin-support PRIVATE plugin-support.c PUBLIC src/${CMAKE_PROJECT_NAME}.h)
...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/install.iss.in")
  configure_file(install.iss.in install.iss)
endif()
